...
const CACHE_NAME = 'nelysnails-v25';
const urlsToCache = [
  '/nelysnails/',
  '/nelysnails/index.html',
  '/nelysnails/admin.html',
  '/nelysnails/admin-login.html',
  '/nelysnails/calendar.html',
  '/nelysnails/setup-wizard.html',
  '/nelysnails/editar-negocio.html',
  '/nelysnails/manifest.json',
  '/nelysnails/icons/icon-72x72.png',
  '/nelysnails/icons/icon-96x96.png',
  '/nelysnails/icons/icon-128x128.png',
  '/nelysnails/icons/icon-144x144.png',
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/nelysnails/icons/icon-192x192.png');
          }
